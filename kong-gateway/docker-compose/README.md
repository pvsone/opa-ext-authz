# Kong Gateway with OPA on Docker Compose
...
The `opa` instance is started with the `policy.rego` file. This file has been modified slightly from the version in the [Envoy Authorization with OPA](https://www.openpolicyagent.org/docs/latest/envoy-introduction/#3-define-a-opa-policy) tutorial, specifically:
